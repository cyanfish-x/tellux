...
export function createGroup(
  ...
  group.className = "tellux-debug-settings__group"

  const header = document.createElement("button")
  header.className = "tellux-debug-settings__group-header"
  header.type = "button"
  ...
  marker.className = "tellux-debug-settings__group-marker"
  marker.setAttribute("aria-hidden", "true")

  const content = document.createElement("div")
  content.className = "tellux-debug-settings__group-content"
...
export function createSwitchControl(
  ...
  wrapper.className = "tellux-debug-settings__switch"

  const input = document.createElement("input")
  input.id = `tellux-debug-settings-${id}`
  input.type = "checkbox"
...
export function createRangeControl(options: RangeControlOptions) {
  const wrapper = document.createElement("label")
  wrapper.className = "tellux-debug-settings__range"

  const header = document.createElement("span")
  header.className = "tellux-debug-settings__range-header"
  ...
  const input = document.createElement("input")
  input.id = `tellux-debug-settings-${options.id}`
  input.type = "range"
...
export function createSelectControl<T extends string>(
  ...
  const wrapper = document.createElement("label")
  wrapper.className = "tellux-debug-settings__select"
