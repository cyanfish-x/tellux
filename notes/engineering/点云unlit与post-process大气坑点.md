...
> 2026-09-06 复核范围：核对 LUT、NormalPass unlit 标记和大气 patch；只保留原抽样数据范围，不把无 normal 泛化为所有 pnts。
...
具体的取舍与升级边界见 [ADR 0002：无法线点云以显示色语义穿过全屏输出链](../decisions/0002-display-referred-point-cloud-colors.md)。
